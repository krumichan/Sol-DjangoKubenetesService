...
# Custom sidebar templates, maps document names to apps_templates names.
html_sidebars = {
...
# A tuple containing the cover image and cover page html apps_templates filenames.
# epub_cover = ()
