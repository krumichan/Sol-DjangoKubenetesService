TL = {
    ...
    "authPage": {
        ...
        "saml": {
            ...
            "disabled": {
                ...
                "testAuth": {
                    "header": "{step}. Test and enable authentication",
                    "subtext": "Check that your application is configured correctly by testing authentication with it:"
                }
            },
            "providerName": {
        ...
        "shibboleth": {
            "buttonText": {
                "pre": "Authenticate with Shibboleth",
                "post": "Waiting to hear back from IDP",
                "edit": "Test Config with Shibboleth"
            },
            "providerName": {
                "shibboleth": "Shibboleth"
            },
            "openLdap": {
                "header": "2. OpenLDAP Search Configuration",
                "detail": "Add your OpenLDAP configuration below to configure search capabilities.",
            ...
            "notAuthenticated": {
                ...
                "form": {
                    ...
                    "nestedGroupMembershipEnabled": {
                        "labelText": "Nested Group Membership"
                    }
                }
            },
            "testAuth": {
    ...
    "banner": {
        "alerting": "Alerts in Cluster Manager has been deprecated as of Rancher v2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. Check out the updated alerts integration in Rancher <a href=\"{dashboardLink}/monitoring\">monitoring</a> in Cluster Explorer Apps and Marketplace.",
        "cis": "CIS Scanning in Cluster Manager has been deprecated as of Rancher 2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. For CIS Scanning with benchmark version 1.5 and above, see the updated <a href=\"{dashboardLink}/cis\">CIS scanning</a> functionality in Cluster Explorer Apps and Marketplace.",
        "dashboard": "Try out the <a href=\"{dashboardLink}\">Cluster Explorer</a> for a new way to view and manage your Kubernetes resources.",
        "istio": "Istio v1.5 has been declared end of life by the upstream project and is now deprecated as of Rancher 2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. Checkout the new <a href=\"{dashboardLink}/istio\">Istio</a> v1.7 integration in the new Cluster Explorer Apps and Marketplace.",
        "logging": "Logging in Cluster Manager has been deprecated as of Rancher v2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. Check out the updated version of <a href=\"{dashboardLink}/logging\">logging</a> in Cluster Explorer Apps and Marketplace.",
        "multiclusterapp": "Multi-Cluster Apps have been deprecated as of Rancher v2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. Check out the new <a href=\"{dashboardBase}c/local/fleet\">Rancher Continuous Delivery</a> capability to deploy apps across multiple clusters through GitOps.",
        "monitoring": "Monitoring in Cluster Manager has been deprecated as of Rancher v2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. Check out the updated version of <a href=\"{dashboardLink}/monitoring\">monitoring</a> in Cluster Explorer Apps and Marketplace.",
        "monitoringV2Warning": "Monitoring in Cluster Manager has been deprecated as of Rancher v2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. The updated version of <a href=\"{dashboardLink}/monitoring\">monitoring</a> in Cluster Explorer Apps and Marketplace is currently deployed.",
        "notifiers": "Notifiers in Cluster Manager has been deprecated as of Rancher v2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. Check out the updated notifier integration in Rancher <a href=\"{dashboardLink}/monitoring\">monitoring</a> in Cluster Explorer Apps and Marketplace.",
        "pipeline": "Pipelines has been deprecated as of Rancher 2.5.0 - check out the <a href=\"https://rancher.com/docs/rancher/v2.x/en/faq/deprecated-features-25x\" target=\"_blank\">FAQ</a>. For continuous delivery capabilities check out <a href=\"{dashboardBase}c/local/fleet\">Rancher Continuous Delivery</a> in the new Cluster Explorer view."
    },
    "catalogPage": {
        "istio": {
    ...
    "cis": {
        "scan": {
            ...
            "modal": {
                ...
                "title": "Run CIS Scan",
                "testsWontRun": "These tests won't run due to the selected profile",
            ...
            "header": "CIS Scans",
            "rkeOnly": "This version of CIS scanning is only available for RKE clusters.",
            "actions": {
                "delete": "Delete",
                "download": "Download",
                "runScan": "Run Scan",
            ...
            "table": {
                ...
                "date": "Date",
                "empty": "There are no scans"
            },
            "detail": {
                "error": {
                    "parseConfig": "There was a problem parsing the security-scan-cfg config map.",
                    "createDefault": "Failed to create the default security-scan-cfg config map."
                },
                "actions": {
                    "delete": "Delete",
                    "download": "Download",
    ...
    "k8sPage": {
        ...
        "configFile": {
            ...
            "usage": {
                ...
                "downloadText": "Then <a href=\"{downloadUrl}\" target=\"_blank\">download</a> (if needed) and run <code>kubectl</code>\n"
            }
        }
    },
    "loginPage": {
    ...
    "notifierPage": {
        ...
        "slack": {
            ...
            "helpText": "Here's how you <a href=\"https://slack.com/apps/A0F7XDUAZ-incoming-webhooks\" target=\"_blank\" rel=\"nofollow noopener noreferrer\">create Incoming WebHooks</a> for Slack.\n"
        },
        "smtp": {
            "server": "Smtp Server",
            "host": "Host",
        ...
        "pagerduty": {
            ...
            "helpText": "Here's how you <a href=\"https://www.pagerduty.com/docs/guides/prometheus-integration-guide/\" target=\"_blank\" rel=\"nofollow noopener noreferrer\">create an Integration Key</a> for PagerDuty.\n"
        },
        "wechat": {
            "recipientType": {
            ...
            "corp": {
                ...
                "helpText": "Click <a href=\"https://work.weixin.qq.com/wework_admin/frame#profile\" target=\"_blank\" rel=\"nofollow noopener noreferrer\">here</a> to find your Corporation ID.\n"
            },
            "defaultRecipient": {
    ...
    "cloudProvider": {
        ...
        "helpText": "Read more about the state of the <a href=\"https://kubernetes.io/blog/2019/04/17/the-future-of-cloud-providers-in-kubernetes/\" target=\"_blank\" rel=\"nofollow noopener noreferrer\">Kubernetes in-tree cloud providers</a>\n",
        ...
        "azureCloudConfig": {
            ...
            "cloud": {
                "description": "The cloud environment identifier. See <a href='https://github.com/kubernetes-sigs/cloud-provider-azure/blob/master/docs/cloud-provider-config.md' target='_blank' rel='nofollow noopener noreferrer'>cloud provider config docs</a> for valid entries"
            },
            "location": {
    ...
    "clusterRow": {
        ...
        "noClusterData": "There are no clusters defined.",
        "addHost": "Add Nodes",
    ...
    "clusterTemplateRow": {
        "label": "RKE Template",
        "noData": "There are no RKE Templates defined.",
        "noMatch": "No RKE Templates match the current search."
    },
    "clusterNew": {
        ...
        "amazoneks": {
            ...
            "subnet": {
                ...
                "noneSelected": "Rancher created VPC, Subnet, and Security Group"
            },
    ...
    "clusterTemplateNew": {
        "members": {
            "label": "Member Roles",
            "detail": "Control who has access to the RKE Template and what permission they have to change it."
        }
    },
    "cruClusterTemplate": {
    ...
    "cruStorageClass": {
        ...
        "volumeBindingMode": {
            ...
            "immediate": "Bind and provision a persistent volume once the PersistentVolumeClaim is created",
            "waitForFirstConsumer": "Bind and provision a persistent volume once a Pod using the PersistentVolumeClaim is created"
        },
        "aws-ebs": {
            "fsType": {
                "label": "Filesystem Type",
    ...
    "gatewayPage": {
        "noMatch": "No Gateways match the current search",
        "noData": "There are no gateways defined",
        "notSupported": "networking.istio.io/v1alpha3 API is not available in the cluster.",
        "table": {
            "hosts": {
                "label": "Hosts"
    ...
    "cruGateway": {
        ...
        "tls": {
            ...
            "serverCertificate": {
                ...
                "placeholder": "e.g. /etc/istio/ingressgateway-certs/tls.crt"
            },
            "privateKey": {
                "label": "Private Key",
                "placeholder": "e.g. /etc/istio/ingressgateway-certs/tls.key"
            },
            "caCertificates": {
                "label": "CA Certificates",
                "placeholder": "e.g. /etc/istio/ingressgateway-ca-certs/ca-chain.cert.pem"
            },
            "credentialName": {
                "label": "Credential Name",
                "placeholder": "e.g. myssl"
            }
        },
        "port": {
            "number": {
        ...
        "servers": {
            "label": "Servers",
            "add": "Add Server",
            "error": "Please input at least one Server",
            "noServers": "No Servers",
            "removeServerLabel": "Remove Server"
        }
    },
    "cruVirtualService": {
        "title": {
    ...
    "featureFlags": {
        ...
        "features": {
            "istioVirtualServiceUi": "Enabling this feature exposes additional UI pages for Istio.",
            "unsupportedStorageDrivers": "Enabling this feature exposes unsupported storage driver options for persistent volumes and storage classes."
        },
        "table": {
            "description": "Description",
            "name": "Name",
    ...
    "formBalancerConfig": {
        ...
        "custom": "See <a href=\"https://cbonte.github.io/haproxy-dconv/1.6/configuration.html\" target=\"_blank\" rel=\"nofollow noopener noreferrer\">haproxy documentation</a> for more info about specific options that can go into the the config file.  When overriding the <code>backend</code> or similar lines which include the IP address of the target container, use <code>$IP</code> where the address goes and {appName} will generate the appropriate line(s).\n",
        "config": {
    ...
    "formCustomMetrics": {
        "title": "Custom Metrics Endpoints",
    ...
    "formLabelsAnnotations": {
        ...
        "detail": "Key/Value pairs that can be used to label/annotate resources."
    },
    ...
    "formVolumeRow": {
        ...
        "customLogPath": {
            "helpText": "A volume will be mounted into the container, and all logs written will be exported to the logging target. This feature is supported on GKE and RKE clusters."
        }
    },
    "formVolumes": {
        "title": "Volumes",
    ...
    "hostSettings": {
        ...
        "notPublic": {
            "alert": "Are you sure all the hosts you will create will be able to reach <code>{activeValue}</code> ?<br/>It looks like a private IP or local network.\n"
        },
        "badTld": {
            "alert": "The <code>.local</code> Top-Level Domain is reserved by RFC6762 for Multicast DNS.  Using this as your Registration URL is strongly discouraged and may cause DNS resolution issues as well as problems with addons like secrets and networked storage drivers.  Please choose a different hostname or IP.\n"
        }
    },
    "hostPod": {
        "supportState": {
    ...
    "nodeGroupRow": {
        ...
        "version": {
            "label": "Kubernetes Version",
            "upgrade": "Upgrade Node Group Version from { from } to { version }",
            "warning": "A new cluster version has been selected. Once completed you may come back and upgrade the node group version."
        }
    },
    "uploadFile": {
    ...
    "loggingPage": {
        ...
        "splunk": {
            ...
            "helpText": "You can find instructions on how to configure Splunk HEC(HTTP Event Collector) <a href=\"http://docs.splunk.com/Documentation/Splunk/7.0.0/Data/UsetheHTTPEventCollector\" target=\"_blank\">here</a>.",
            "token": "Token",
    ...
    "modalEditPassword": {
        "firstLogin": {
            ...
            "help": "Set password for the default <code>admin</code> user",
            "setView": "Set Default View",
    ...
    "modalRestoreBackup": {
        ...
        "type": {
            ...
            "etcd": "etcd",
            "k8sVersion": "etcd and Kubernetes Version",
            "versionUnknown": "Unknown",
            "etcdAndK8sVersion": "etcd, Kubernetes Version and cluster config",
    ...
    "telemetryOpt": {
        "header": "Statistics",
        "subtext": "Rancher Labs would like to collect anonymous information about the configuration of your installation to help make {appName} better.<br/>Your data will not be shared with anyone else, and no specific resource names or addresses are collected.\n",
        "learnMore": {
            "label": "Learn More"
        },
