...
from links.c.storage.persistentvolumes.services.persistentvolumes_service import PersistentVolumesService


class PersistentVolumesMapper:
    ...
    def _list_persistent_volumes(self, **arguments):
        payload = {
            CC.OPTIONS_STRING: {
                "me": "true"
            }
        ...
        return self._me.__forward(
            func_name="list_persistent_volumes"
            , payload=payload
            , html_name="index.html"
            , js_name="index.js"
        )

    def _add_form_persistent_volume(self, **arguments):
        payload = {
            CC.OPTIONS_STRING: {
                "me": "true"
            }
        ...
        return self._me.__forward(
            func_name="add_form_persistent_volume"
            , payload=payload
            , html_name="createForm.html"
            , js_name="createForm.js"
        )

    def _add_persistent_volume(self, **arguments):
        payload = {
            CC.OPTIONS_STRING: json.loads(self._me.__request.POST.get("persistentVolumeData"))
        }

        return self._me.__redirect(
            func_name="add_persistent_volume"
            , payload=payload
            , redirect_path="c/" + self._me.__cluster_id + "/persistent-volumes"
        )

    def _detail_persistent_volume(self, **arguments):
        payload = {
            CC.OPTIONS_STRING: {
        ...
        return self._me.__forward(
            func_name="detail_persistent_volume"
            , payload=payload
    ...
    def __forward(self, func_name, payload, html_name, js_name=""):
        ...
        context = {
            ...
            CC.MODEL_STRING:
                t.__pv_service.request_mapping(func_name=func_name, cluster_id=t.__cluster_id, payload=payload)
