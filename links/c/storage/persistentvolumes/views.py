...
def validate(request, cluster_id, callback, mapper, name=None, names=None, search=None):
    """
...
def check_clsterid(clusterid):
    """
    url로부터 넘어온 cluster id가 유효한지 검사.\n
    :param clusterid: url로부터 넘어온 cluster id.
    :return: 검사 결과.
    """
    if not clusterid:
        raise Exception("Cluster Id does not exist.")
