...
from links.g.clusters.services.noderun_service import NodeRunService
...
class NodeRunMapper:
    ...
    def __new__(cls):
        ...
        if not hasattr(cls, "_me"):
            # instance 생성.
            cls._me = super(NodeRunMapper, cls).__new__(cls)
            # 해당 instance의 필수 요구 member 생성.
            cls._me.__share = Share()
            cls._me.__s_service = NodeRunService()
    ...
    def __forward(self, func_name, payload, html_name, js_name=""):
        ...
        context = {
            ...
            CC.MODEL_STRING:
                t.__s_service.request_mapping(func_name=func_name, payload=payload)
