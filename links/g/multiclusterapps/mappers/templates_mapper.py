...
from links.g.multiclusterapps.services.templates_service import TemplatesService
...
class TemplatesMapper:
    ...
    def __new__(cls):
        ...
        if not hasattr(cls, "_me"):
            # instance 생성.
            cls._me = super(TemplatesMapper, cls).__new__(cls)
            # 해당 instance의 필수 요구 member 생성.
            cls._me.__share = Share()
            cls._me.__t_service = TemplatesService()
    ...
    def _list_templates(self, **arguments):
        payload = {
            CC.OPTIONS_STRING: {
                "me": "true"
            }
        ...
        return self._me.__forward(
            func_name="list_multi_cluster_application_templates"
            , payload=payload
            , html_name="templates/index.html"
            , js_name="templates/index.js"
        )

    def _filter_templates(self, **arguments):
        payload = {
            CC.OPTIONS_STRING: {
                "category": arguments[CC.NAME_STRING]
            }
        }

        return self._me.__forward(
            func_name="filter_by_category_multi_cluster_application_templates"
            , payload=payload
            , html_name="templates/index.html"
            , js_name="templates/index.js"
        )

    def _refresh_templates(self, **arguments):
        payload = {
            CC.OPTIONS_STRING: {
                "me": "true"
            }
        ...
        return self._me.__redirect(
            func_name="refresh_multi_cluster_application_templates"
            , payload=payload
            , redirect_path="/g/multi-cluster-apps/templates"
        )
    ...
    def __forward(self, func_name, payload, html_name, js_name=""):
        ...
        context = {
            ...
            CC.MODEL_STRING:
                t.__t_service.request_mapping(func_name=func_name, payload=payload)
