...
from links.g.security.authentication.services.authentication_service import AuthenticationService
...
class AuthenticationMapper:
    ...
    def __new__(cls):
        ...
        if not hasattr(cls, "_me"):
            # instance 생성.
            cls._me = super(AuthenticationMapper, cls).__new__(cls)
            # 해당 instance의 필수 요구 member 생성.
            cls._me.__share = Share()
            cls._me.__u_service = AuthenticationService()
