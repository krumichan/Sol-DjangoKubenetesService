...
from links.g.settings.services.advancedsettings_service import AdvancedSettingService


class AdvancedSettingsMapper:
    ...
    def __new__(cls):
        ...
        if not hasattr(cls, "_me"):
            # instance 생성.
            cls._me = super(AdvancedSettingsMapper, cls).__new__(cls)
            # 해당 instance의 필수 요구 member 생성.
            cls._me.__share = Share()
            cls._me.__u_service = AdvancedSettingService()
