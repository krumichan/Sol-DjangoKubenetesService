...
from links.g.settings.services.fetureflags_service import FetureFlagsService


class FetureFlagsMapper:
    ...
    def __new__(cls):
        ...
        if not hasattr(cls, "_me"):
            # instance 생성.
            cls._me = super(FetureFlagsMapper, cls).__new__(cls)
            # 해당 instance의 필수 요구 member 생성.
            cls._me.__share = Share()
            cls._me.__u_service = FetureFlagsService()
