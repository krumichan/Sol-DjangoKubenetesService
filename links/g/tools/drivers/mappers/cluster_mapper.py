...
from links.g.tools.drivers.services.cluster_service import ClusterService
...
class ClusterMapper:
    ...
    def __new__(cls):
        ...
        if not hasattr(cls, "_me"):
            # instance 생성.
            cls._me = super(ClusterMapper, cls).__new__(cls)
            # 해당 instance의 필수 요구 member 생성.
            cls._me.__share = Share()
            cls._me.__c_service = ClusterService()
