...
from links.g.tools.drivers.services.create_cluster_service import CreateClusterService


class CreateClusterMapper:
    ...
    def __new__(cls):
        ...
        if not hasattr(cls, "_me"):
            # instance 생성.
            cls._me = super(CreateClusterMapper, cls).__new__(cls)
            # 해당 instance의 필수 요구 member 생성.
            cls._me.__share = Share()
            cls._me.__cc_service = CreateClusterService()
    ...
    def __response(self, func_name, payload, html_name, js_name=""):
