...
from links.g.tools.drivers.services.create_node_service import CreateNodeService


class CreateNodeMapper:
    ...
    def __new__(cls):
        ...
        if not hasattr(cls, "_me"):
            # instance 생성.
            cls._me = super(CreateNodeMapper, cls).__new__(cls)
            # 해당 instance의 필수 요구 member 생성.
            cls._me.__share = Share()
            cls._me.__cn_service = CreateNodeService()
